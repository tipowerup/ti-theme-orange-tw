        ...
        <div class="text-center py-12">
            ...
            <div class="mt-6">
                <a
                    ...
                    wire:navigate
                    class="inline-flex items-center px-4 py-2 border border-transparent shadow-xs text-sm font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-surface focus:ring-primary-500"
                >
