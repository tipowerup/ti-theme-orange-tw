<div
    ...
    @class([
        'bg-body dark:bg-surface border border-border dark:border-border rounded-lg p-4 transition-all',
    ...
    <div class="flex gap-4">
        ...
        <div class="flex-1 min-w-0">
            <div class="flex items-start justify-between mb-2">
                <h3 class="text-lg font-semibold text-text dark:text-text">{{ $menuItemData->name }}</h3>
                @unless($showThumb)
                    <button
                        type="button"
                        @class([
                    ...
                    >
                        <i @class([
                            'fas fa-plus' => $menuItemData->mealtimeIsAvailable(),
            ...
            @if($menuItemData->description)
                <p class="text-sm text-text-muted dark:text-text-muted mb-3 line-clamp-2">
