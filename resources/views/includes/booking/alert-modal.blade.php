...
>
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div
            ...
            class="fixed inset-0 transition-opacity bg-surface/75 dark:bg-body/75"
            @click="show = false"
        ></div>
        ...
        >
            <div class="px-6 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <div class="flex items-center justify-center shrink-0 w-12 h-12 mx-auto bg-red-100 dark:bg-red-900/30 rounded-full sm:mx-0 sm:h-10 sm:w-10">
            ...
            <div class="px-4 py-3 bg-surface dark:bg-surface sm:px-6 sm:flex sm:flex-row-reverse">
                <button
                    type="button"
                    @click="show = false"
                    class="w-full px-4 py-2 text-base font-medium text-white bg-primary-600 hover:bg-primary-700 border border-transparent rounded-lg shadow-xs sm:ml-3 sm:w-auto sm:text-sm transition-colors"
                >
