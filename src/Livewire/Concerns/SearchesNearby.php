...
trait SearchesNearby
{
    ...
    /**
     * Geocode user's current position using browser geolocation coordinates or search query.
     *
     * Accepts either:
     * - Array coordinates from browser geolocation [latitude, longitude]
     * - String address from user input
     *
     * @return GeoliteLocation Geocoded location with coordinates and address data
     *
     * @throws ValidationException When search query is empty or geocoding fails
     */
