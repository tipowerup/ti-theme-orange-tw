...
use Throwable;
use TiPowerUp\OrangeTw\Livewire\Forms\LoginForm;
...
final class Login extends Component
{
    ...
    {
        return [
            'code' => 'tipowerup-orange-tw::login',
            'name' => 'tipowerup.orange-tw::default.component_login_title',
            'description' => 'tipowerup.orange-tw::default.component_login_desc',
        ];
    }
    ...
    {
        return view('tipowerup-orange-tw::livewire.login');
    }
