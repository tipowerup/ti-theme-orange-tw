...
use TiPowerUp\OrangeTw\Livewire\Forms\RegisterForm;
...
final class Register extends Component
{
    ...
    {
        return [
            'code' => 'tipowerup-orange-tw::register',
            'name' => 'tipowerup.orange-tw::default.component_register_title',
            'description' => 'tipowerup.orange-tw::default.component_register_desc',
        ];
    }
    ...
    {
        return view('tipowerup-orange-tw::livewire.register');
    }
    ...
    public function onRegister(): mixed
    {
    ...
    public function onActivate(): mixed
    {
        $this->validate([
