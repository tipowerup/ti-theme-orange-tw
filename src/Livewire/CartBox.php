...
final class CartBox extends Component
{
    ...
    {
        return [
            'code' => 'tipowerup-orange-tw::cart-box',
            'name' => 'Cart Box',
            'description' => 'Displays the shopping cart with items, totals, and checkout options',
        ];
    }
    ...
    {
        return view('tipowerup-orange-tw::livewire.cart-box', [
            'previewMode' => false,
    ...
    #[On('hideModal')]
    public function onHideModal(): void
    {
