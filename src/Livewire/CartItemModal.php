...
final class CartItemModal extends ModalComponent
{
    ...
    {
        return [
            'code' => 'tipowerup-orange-tw::cart-item-modal',
            'name' => 'Cart Item Modal',
            'description' => 'Modal for adding or editing cart items with options',
        ];
    }
    ...
    {
        return view('tipowerup-orange-tw::livewire.cart-item-modal', [
